  ...
  useEffect(() => {
    const onClick = async (event: MouseEvent) => {
      ...
      try {
        ...
        // A coleta server-side é apenas a primeira tentativa. Alguns anúncios
        // bloqueiam os endpoints públicos mesmo tendo avaliações visíveis quando
        // o usuário está logado no navegador. Nesse caso, a falha NÃO encerra o
        // botão: ela deve cair automaticamente para a extensão do Chrome.
        try {
