...
- [ ] **Fase 2 — Catálogo:** `products`, `product_variants`, `categories`, `brands`, `collections`, `product_media`, `product_prices`, `product_inventory`, `product_reviews`, `product_seo`, `homepage_blocks`, busca com debounce, filtros, página de produto, favoritos, carrinho local.
